...
## Tech Stack
[![My Skills](https://skillicons.dev/icons?i=react,redux,js,typescript,html,css,scss,tailwind,bootstrap,vite,webpack,npm,nodejs,express,pug,nextjs,nestjs,mongodb,postman,figma,java,python,opencv,firebase,mysql,sequelize,postgres,c,cpp,unreal)](https://skillicons.dev)

...
## Tech Stack
[![My Skills](https://skillicons.dev/icons?i=react,redux,js,typescript,html,css,scss,tailwind,bootstrap,vite,vitest,webpack,npm,nodejs,express,pug,nextjs,nestjs,mongodb,postman,figma,java,python,firebase,mysql,sequelize,postgres,c,cpp,unreal)](https://skillicons.dev)
